...
for (networkID,repNum,TL) in [(0,10,3600*5),(8,10,3600*5),(6,10,3600*5),(7,10,3600*5),(1,10,3600*5)]:#[(9,50,3600),(5,50,3600),(3,50,3600),(4,50,3600),(2,50,3600),(0,10,3600*5),(8,10,3600*5),(6,10,3600*5),(7,10,3600*5),(1,10,3600*5)]:
    ...
    for rep in range(repNum):        
        ...
        if warm == True:
            incumbent = pd.read_csv('3_result_LS/lopt/lopt_DLS_Net%s_Rep%s_logSum%s.csv'%(networkID,rep,int(logSum * 100))) 
        ...
        model.setParam('LogFile','6_result_solver/grblog/grblog_NLCC_%s_%s_logSum%s_Bound%s_warm%s.txt'%(networkID,rep,int(logSum*100),bounding,warm))        
        ...
        optSolution.to_csv(r'6_result_solver/opt/opt_NLCC_%s_%s_logSum%s_Bound%s_warm%s.csv'%(networkID,rep,int(logSum*100),bounding,warm), index = False)#Check
        ...
        if timeLimit == True:
            ...
            summary.to_csv(r'6_result_solver/summary_NLCC_%s_logSum%s_Bound%s_warm%s.csv'%(networkID,int(logSum*100),bounding,warm), index = False)#Check
